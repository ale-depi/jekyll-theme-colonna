...
Jekyll content files, also it shows whether basic HTML elements are decorated
with CSS in a Jekyll theme.
...
Tables aren't part of the core Markdown spec, but Jekyll supports them
out-of-the-box.
